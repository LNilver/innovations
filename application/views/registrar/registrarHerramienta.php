<div id="todo">
    <div style="text-align: center; margin-top: 60px;">
        <h1 class="text-white">REGISTRAR HERRAMIENTA</h1>
    </div>
        ...
        <div class="panel panel-info">
            <div class="panel-body">
                <form id="registro" name="registro" method="post" action="<?php echo base_url('Inventario_controlador/registrar_herramienta')?>">
                    <input type="hidden" name="herramienta" value="SI">
                    <fieldset>
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Estado de Encuentro</label>
                                        <select class="form-control custom-select" name="estadoencuentraherramienta" id="estadoencuentraherramienta" required>
